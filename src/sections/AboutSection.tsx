        ...
        <section className="w-full flex flex-col-reverse md:flex-row-reverse items-center">
            <div className="text md:w-1/2 col gap-4 my-2">
                <Heading
                    className="max-w-[90%]"
                    heading="About Us"
                    subHeading="Discover Smart Cargo Marketplace"
                />
                <span className="text-app_gray/80 leading-8 text-xl">
                At our state-of-the-art cargo transportation marketplace. We connect businesses and truck owners for efficient, cost-effective logistics solutions powered by AI and blockchain technology.
                </span>
